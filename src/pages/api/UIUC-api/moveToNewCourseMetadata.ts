...
export default async function handler(
	...
	try {
		...
		for (const oldKey of oldMetadataKeys) {
			...
			const oldMetadata: CourseMetadata = await kv.get(oldKey) as CourseMetadata
			...
			const existingMetadata: CourseMetadata | object = (await kv.hget('course_metadatas', courseName)) || {}
