...
export const fetchRoutingResponse = async (
	...
	const question = (message.content as Content[]).filter(
		...
		messages: [
			{
				...
				content: [
					...
					{					
						type: 'text',
						text: `Given the user question and images, classify it as either being about \`Pests\`, or \`Other\`.
						Do not respond with more than one word.
						Even if the user doesn't explicitly ask about pests, if the image is about pests, classify it as such.
						<question>
						${question}
						</question>
						Classification:`,
