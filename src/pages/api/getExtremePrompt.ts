...
export async function getExtremePrompt(
  ...
  const res = await fetch(
    `https://flask-doc-groups.up.railway.app/getContextStuffedPrompt?course_name=${course_name}&search_query=${search_query}&top_n=${top_n}&top_k_to_search=${top_k_to_search}`,
    {
      method: 'GET',
    },
  )
