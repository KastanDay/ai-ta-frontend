    ...
    async (message: Message, deleteCount = 0, plugin: Plugin | null = null) => {
      ...
      if (selectedConversation) {
        ...
        if (deleteCount) {
          ...
          currentMessageIndex = updatedMessages.length - 1 - deleteCount
          //TODO: Remove the images generated by one of the tools from the message
          ...
          currentMessageIndex = selectedConversation.messages.length - 1
          updatedConversation = {
            ...selectedConversation,
