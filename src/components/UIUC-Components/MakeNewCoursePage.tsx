...
import {
  ...
  Textarea,
  FileInput,
  MediaQuery, type CheckboxProps, Title,
} from '@mantine/core'
...
const MakeNewCoursePage = ({
  ...
  return (
      <>
        ...
        <main className="course-page-main" style={{ display: 'flex', justifyContent: 'center', alignItems: 'start', minHeight: '100vh', padding: '1rem'}}>
          <EditCourseCard course_name={course_name}
